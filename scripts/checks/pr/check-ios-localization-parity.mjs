...
const REQUIRED_LOCALES = ["ar", "bg", "bn", "ca", "cs", "da", "de", "el", "es-ES", "es-MX", "et", "fa", "fi", "fr", "gu", "he", "hi", "hr", "hu", "id", "is", "it", "ja", "kn", "ko", "lt", "lv", "ml", "mr", "nb", "nl", "pa", "pl", "pt-BR", "ro", "ru", "sk", "sl", "sv", "sw", "ta", "te", "th", "tr", "uk", "zh-Hans"];
