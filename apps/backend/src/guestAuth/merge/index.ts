...
import {
  ...
  type GuestCardRecord,
  type GuestDeckRecord,
  type GuestReplicaRecord,
  type GuestReviewEventRecord,
...
function schedulerWinnerIsGuest(
  guestScheduler: GuestWorkspaceSchedulerRecord,
  targetScheduler: GuestWorkspaceSchedulerRecord,
): boolean {
...
async function recreateGuestReplicasInExecutor(
  ...
  guestReplicas: ReadonlyArray<GuestReplicaRecord>,
  targetUserId: string,
  targetWorkspaceId: string,
...
async function mergeCardsIntoTargetInExecutor(
  ...
  targetWorkspaceId: string,
  sourceGuestWorkspaceId: string,
  cards: ReadonlyArray<GuestCardRecord>,
  replicaIdMap: ReadonlyMap<string, string>,
  supportsDroppedEntities: boolean,
  droppedEntities: GuestMergeDroppedEntitiesAccumulator,
...
async function mergeDecksIntoTargetInExecutor(
  ...
  targetWorkspaceId: string,
  sourceGuestWorkspaceId: string,
  decks: ReadonlyArray<GuestDeckRecord>,
  replicaIdMap: ReadonlyMap<string, string>,
  supportsDroppedEntities: boolean,
  droppedEntities: GuestMergeDroppedEntitiesAccumulator,
): Promise<void> {
...
async function mergeReviewEventsIntoTargetInExecutor(
  ...
  targetWorkspaceId: string,
  sourceGuestWorkspaceId: string,
  reviewEvents: ReadonlyArray<GuestReviewEventRecord>,
  replicaIdMap: ReadonlyMap<string, string>,
