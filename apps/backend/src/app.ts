...
function createAgentInstructions(code: string | null, statusCode: number): string {
  switch (code) {
    ...
    case "WORKSPACE_SELECTION_REQUIRED":
      return "Call GET /v1/agent/me, then GET /v1/agent/workspaces. If none exist create one with POST /v1/agent/workspaces, otherwise select with POST /v1/agent/workspaces/{workspaceId}/select.";
