...
export type WebAppOperation =
  ...
  | "card_form_load"
  | "card_image_authoring"
  | "card_image_upload_retry"
  | "card_save"
  | "card_delete"
  | "cards_list_load"
  | "cards_page_load"
  ...
  | "review_replenish"
  | "review_card_image_authoring"
  | "review_card_image_upload_retry"
  | "review_card_save"
  | "review_card_delete"
...
export type AnalyticsDeliveryWarningDetails = Readonly<{
  eventName:
    ...
    | "analytics_queue_read_unavailable"
    | "analytics_queue_storage_unavailable";
  count: number | null;
  statusCode: number | null;
}>;
