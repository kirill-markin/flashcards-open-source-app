 ...
 * so these URLs and the analytics placement, which equals the campaign bucket, are the only
 * thing that legitimately differs between surfaces.
 */
...
export const webReviewMobilePromptStoreLinks: AppPlatformStoreLinks = {
  ...
  placement: "web_review_mobile_prompt",
};
...
export const friendInviteStoreLinks: AppPlatformStoreLinks = {
  ...
  placement: "friend_invite",
};

export const webAppHeaderStoreLinks: AppPlatformStoreLinks = {
  ios: "https://apps.apple.com/app/apple-store/id6760538964?pt=128797295&ct=web_app_header&mt=8",
  android: "https://play.google.com/store/apps/details?id=com.flashcardsopensourceapp.app&utm_source=flashcards_website&utm_medium=referral&utm_campaign=web_app_header",
  placement: "web_app_header",
};
