...
type AnalyticsDeliveryRuntime = Readonly<{
  ...
  startAnalytics: () => () => void;
  setAnalyticsGuestOwnerId: (nextGuestOwnerId: string | null) => void;
  setAnalyticsConfirmedOwner: (userId: string, credential: AnalyticsRequestCredential) => void;
  readAnalyticsSessionOwnerId: () => string | null;
  registerAnalyticsGuestCredentialRefusalHandler: (handler: () => void) => () => void;
}>;
...
export function createAnalyticsDeliveryRuntime(
  ...
  function registerAnalyticsGuestCredentialRefusalHandler(handler: () => void): () => void {
   ...
   */
  function setAnalyticsGuestOwnerId(nextGuestOwnerId: string | null): void {
   ...
   */
  function setAnalyticsConfirmedOwner(
    userId: string,
    credential: AnalyticsRequestCredential,
  ): void {
    try {
