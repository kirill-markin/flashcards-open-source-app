...
const arCatalog: TranslationCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        readyBody: "رابط الدعوة جاهز. ينتهي في {{expiresAt}}.",
        ...
        shareText: "انضم إلى لوحة الصدارة الخاصة بي في Flashcards.",
  ...
  friendInvite: {
    ...
    signInTitle: "سجّل الدخول لقبول هذه الدعوة",
    signInBody: "يمكن لهذه الدعوة ربط لوحة الصدارة الخاصة بك بالشخص الذي أرسلها. سجّل الدخول أولًا، ثم اختر كيف يظهر اسمه لديك.",
    signInButton: "تسجيل الدخول",
    formTitle: "قبول دعوة صديق",
    formBody: "اختر اسمًا خاصًا قبل القبول.",
    displayNameLabel: "كيف تريد أن ترى الشخص الذي أرسل لك هذا الرابط؟",
    accept: "قبول الدعوة",
    accepting: "جارٍ القبول...",
    successTitle: "أصبحتما صديقين الآن",
    successBody: "يمكنكما الآن العثور على بعضكما في لوحة الصدارة.",
    alreadyFriendsTitle: "أنتما صديقان بالفعل",
    alreadyFriendsBody: "هذا الصديق محفوظ باسم {{name}}.",
