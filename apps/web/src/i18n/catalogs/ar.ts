...
const arCatalog: TranslationCatalog = {
  ...
  analyticsConsentBanner: {
    ...
    message: "نستخدم ملف تعريف ارتباط ووسائل تخزين أخرى في المتصفح لقياس كيفية استخدام التطبيق. قبل اختيارك، لا يُخزَّن شيء على هذا الجهاز ولا يُرسَل أي شيء يعرّف بك.",
    allow: "السماح",
    decline: "الرفض",
  ...
  analyticsSettings: {
    ...
    toggleDescription: "عند إيقافه، لا يحصل هذا المتصفح على أي معرّف ولا يُخزَّن فيه شيء للتحليلات. وما دمت مسجّل الدخول، يبقى ما يُقاس مسجَّلاً على حسابك.",
    error: "لم تنجح العملية. حاول مرة أخرى.",
  },
