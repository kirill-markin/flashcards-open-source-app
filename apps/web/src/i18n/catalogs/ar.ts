...
const arCatalog: TranslationCatalog = {
  ...
  analyticsSettings: {
    ...
    toggleDescription: "عند إيقافه، لا يمنح هذا التطبيق هذا المتصفح أي معرّف ولا يُخزِّن فيه شيئًا للتحليلات. يظل الاستخدام يُحتسب بشكل مجهول الهوية، وما دمت مسجّل الدخول يُسجَّل على حسابك.",
    error: "لم تنجح العملية. حاول مرة أخرى.",
