...
const arCatalog: TranslationCatalog = {
  ...
  analyticsSettings: {
    ...
    toggleDescription: "عند إيقافه، لا يمنح هذا التطبيق هذا المتصفح أي معرّف ولا يُخزِّن فيه شيئًا للتحليلات. وما دمت مسجّل الدخول، يبقى ما يُقاس مسجَّلاً على حسابك.",
    error: "لم تنجح العملية. حاول مرة أخرى.",
