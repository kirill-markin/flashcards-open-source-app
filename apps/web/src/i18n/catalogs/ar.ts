...
const arCatalog: TranslationCatalog = {
  ...
  catalogImport: {
    ...
    errorBody: "تعذر تحميل حزمة الكتالوج. حاول مرة أخرى.",
    unavailableTitle: "إصدار الحزمة غير متاح",
    invalidVersion: "رابط استيراد الكتالوج هذا غير صالح. تحقق من الرابط الكامل وحاول مرة أخرى.",
    versionUnavailable: "إصدار الحزمة هذا مفقود أو لم يعد عامًا. تحقق من الرابط أو اطلب رابطًا حديثًا.",
    ...
    installTitle: "حزمة الكتالوج",
    installDescription: "راجع إصدار الحزمة هذا قبل الاستيراد.",
    previewSourceCatalog: "الكتالوج العام",
    previewVersionLabel: "الإصدار",
    advancedTitle: "إعدادات متقدمة",
    previewRequired: "معاينة الحزمة ليست جاهزة بعد. انتظر اكتمال تحميلها أو حاول مرة أخرى.",
    confirm: "استيراد حزمة الكتالوج",
  ...
  demoCard: {
    ...
    back1: "{{appName}} — التطبيق الذي تنظر إليه الآن.",
    back2: "كل شيء هنا عبارة عن بطاقة: سؤال في الوجه الأمامي، والإجابة في الوجه الخلفي. يمكنك كتابة البطاقات بنفسك، أو تكتفي بإعطاء موضوع لدردشة الذكاء الاصطناعي المدمجة فتنشئ لك مجموعة من البطاقات.",
    back3: "أثناء المراجعة تحاول تذكر الإجابة، ثم تقيّم كيف سارت المحاولة. بعد ذلك تجدول كل بطاقة موعدها بنفسها: ما تعرفه جيدًا يعود بعد أسابيع أو أشهر، وما تنساه باستمرار يعود اليوم أو غدًا.",
    back4: "قيّم بصدق، فهذا ما يجعل الطريقة ناجحة. إذا لم تكن تعرف الإجابة، فاختر {{againLabel}} — بما في ذلك عندما تضطر إلى إلقاء نظرة على الإجابة. خيار {{hardLabel}} مخصص فقط للإجابات التي عرفتها لكن كان من الصعب تذكرها.",
    back5: "جرّب ذلك الآن: قيّم هذه البطاقة بـ {{againLabel}}، وستعود بعد دقيقة تقريبًا حتى ترسخ هذه الإجابة.",
  },
  mobileAppPromo: {
