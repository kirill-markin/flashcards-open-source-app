...
const esMxCatalog: TranslationCatalog = {
  ...
  catalogImport: {
    ...
    signInBody: "Usa la pantalla combinada de inicio de sesión y registro y regresa aquí para elegir un espacio de trabajo e importar el paquete.",
    signInAction: "Continuar para iniciar sesión",
    errorTitle: "Importación del catálogo no disponible",
    errorBody: "No se pudo cargar el paquete del catálogo. Inténtalo de nuevo.",
    unavailableTitle: "Versión del paquete no disponible",
    invalidVersion: "Esta URL de importación no es válida. Revisa el enlace completo e inténtalo de nuevo.",
    versionUnavailable: "Esta versión exacta no existe o ya no es pública. Revisa el enlace o solicita uno actualizado.",
    ...
    installTitle: "Paquete del catálogo",
    installDescription: "Revisa esta versión exacta antes de importarla.",
    previewSourceCatalog: "Catálogo público",
    previewVersionLabel: "Versión",
    advancedTitle: "Configuración avanzada",
    previewRequired: "La vista previa del paquete aún no está lista. Espera a que se cargue o inténtalo de nuevo.",
    confirm: "Importar paquete del catálogo",
