const enCatalog = {
  premium: {
    ...
    subscriptionDescription: "Your current access and AI allowance.",
    unknown: "Your subscription status is currently unknown.",
    statusNone: "No paid subscription",
    grace: "Access continues during the payment grace period.",
    trial: "Trial period",
    renews: "Renews on {{date}}",
    until: "Access until {{date}}",
    noExpiry: "No expiry",
    monthlyMessages: "{{count}} AI messages per month",
    offer: "View Premium",
    close: "Close",
    back: "Back",
    limitTitle: "AI message limit reached",
    previewOffer: "Preview Premium offer",
    previewAi: "Preview AI limit",
    retryManually: "Return to chat and send your message again when ready. Your key settings are saved automatically.",
  },
  common: {
    active: "Active",
    automatic: "Automatic",
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        shareTitle: "Nibomo friend invite",
        shareText: "Open this Nibomo invite, sign in or sign up, and we will see each other in the app.",
  ...
  friendInvite: {
    ...
    signInTitle: "Join Nibomo with this invite",
    signInBody: "Nibomo is a study app for remembering with flashcards. This invite connects you with the person who sent it, so you can see each other in stats like leaderboards. Continue with your email to use the app and connect.",
    ...
    successBody: "You are friends in Nibomo. For now, you can find each other on the leaderboard.",
  ...
  settingsHome: {
    ...
    shareApp: {
      ...
      value: "Share",
      shareTitle: "Study with Nibomo",
      shareText: "Open Nibomo on iOS, Android, or the web.",
      shared: "Share sheet opened.",
      shareUnavailable: "Sharing is not available in this browser.",
    },
    reviewAppStore: {
      title: "Review in App Store",
      description: "Rate Nibomo on its App Store listing.",
    },
    privateFeedback: {
      title: "Share private feedback",
      description: "Send feedback directly to the Nibomo team.",
    },
    currentWorkspace: {
      title: "Workspace",
  ...
  settingsWorkspace: {
    ...
    import: {
      title: "Import",
      description: "Paste terms and definitions or import a Nibomo package.",
      value: "Text or ZIP",
    },
    resetProgress: {
  ...
  workspaceExport: {
    ...
    cardSelectionTagLabel: "Cards tagged {{tag}} ({{count}})",
  ...
  workspaceImport: {
    title: "Import",
    subtitle: "Add cards by pasting text or choosing a Nibomo package.",
    workspaceUnavailable: "Workspace is unavailable",
    textTitle: "Paste text",
    textDescription: "Copy terms and definitions from Quizlet, a spreadsheet, or a document. Review every card before importing.",
    textInputLabel: "Terms and definitions",
    textPlaceholder: "Term 1\tDefinition 1\nTerm 2\tDefinition 2",
    fieldSeparatorLabel: "Between front and back",
    cardSeparatorLabel: "Between cards",
    separatorTab: "Tab",
    separatorComma: "Comma",
    separatorNewLine: "New line",
    separatorSemicolon: "Semicolon",
    separatorCustom: "Custom",
    customFieldSeparatorLabel: "Custom front and back separator",
    customCardSeparatorLabel: "Custom card separator",
    ...
    textDeleteInvalid: "Delete all invalid",
    textTooManyCards: "Import up to {{count}} cards at a time.",
    textTooLarge: "The pasted data is too large to import at once. Split it into smaller imports and try again.",
    textPreviewPaginationLabel: "Card preview pages",
    previousPage: "Previous",
    nextPage: "Next",
    pageStatus: "Page {{current}} of {{total}}",
    textImportButton: "Import {{count}}",
    textImporting: "Importing cards...",
    packageTitle: "Nibomo package",
    packageDescription: "Import a flashcards.zip file previously exported from Nibomo.",
    ...
    packageInvalid: "This file is not a valid flashcards.zip. Choose a package exported from Nibomo.",
    packageTooLarge: "The selected package is too large. Choose a smaller flashcards.zip.",
    packageImportSuccess: "Imported {{count}}.",
    packageImportSuccessWithTag: "Imported {{count}} with tag {{tag}}.",
    ...
    previewRemoveTagLabel: "Remove {{tag}} ({{count}})",
  },
  catalogImport: {
    title: "Import deck from catalog",
    loading: "Loading catalog deck...",
    packageSummary: "{{title}} — {{count}}",
    author: "By {{author}}",
    accountEmail: "Signed in as {{email}}",
    signInTitle: "Sign in or create an account",
    signInBody: "Use the combined login and sign-up screen, then return here to choose a workspace and import this deck.",
    signInAction: "Continue to login or sign up",
    errorTitle: "Catalog import unavailable",
    errorBody: "The catalog deck could not be loaded. Try again.",
    unavailableTitle: "Deck version unavailable",
    invalidVersion: "This catalog import URL is invalid. Check the complete link and try again.",
    versionUnavailable: "This exact deck version is missing or no longer public. Check the link or request a current one.",
    ...
    installTitle: "Catalog deck",
    installDescription: "Review this exact deck version before importing.",
    previewSourceCatalog: "Public catalog",
    previewVersionLabel: "Version",
    advancedTitle: "Advanced settings",
    previewRequired: "The deck preview is not ready yet. Wait for it to load or try again.",
    confirm: "Import this deck",
    installing: "Importing...",
    back: "Back",
    success: "Imported {{count}}. Sync will make them available on your devices.",
    successWithTag: "Imported {{count}} with tag {{tag}}. Sync will make them available on your devices.",
  ...
  analyticsSettings: {
    title: "Analytics",
    subtitle: "Choose what this app measures and whether this browser carries an analytics cookie.",
    collectionToggleTitle: "Allow product analytics",
    collectionToggleDescription: "When this is off, this app collects and sends nothing about how you use it. Crash and error reports are not affected.",
    toggleTitle: "Allow analytics cookies",
    toggleDescription: "When this is off, this app gives this browser no identifier and keeps nothing on it for analytics. It does not turn product analytics off; the setting above does that.",
    error: "That did not go through. Please try again.",
  ...
  accessSettings: {
    ...
    permission: {
      ...
      errorNotAllowedDeniedCamera: "Nibomo cannot use your camera. Click the site controls in your browser bar and enable camera access, then try again.",
      errorNotAllowedDeniedMicrophone: "Nibomo cannot use your microphone. Click the site controls in your browser bar and enable microphone access, then try again.",
  ...
  chatMessageContent: {
    ...
    toolLabels: {
      ...
      nextReviewCard: "Next review card",
      revealAnswer: "Reveal answer",
      sql: "SQL",
      sqlExecute: "SQL write",
      sqlQuery: "SQL query",
