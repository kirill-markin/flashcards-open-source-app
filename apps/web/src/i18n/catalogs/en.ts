const enCatalog = {
  ...
  catalogImport: {
    ...
    installDescription: "Review this exact package version and choose how its tags should be imported.",
    previewSourceCatalog: "Public catalog",
    previewVersionLabel: "Version",
    advancedTitle: "Advanced settings",
    previewRequired: "Refresh the package preview before importing.",
