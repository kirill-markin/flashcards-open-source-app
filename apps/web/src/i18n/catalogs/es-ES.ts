...
const esEsCatalog: TranslationCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        creating: "Creando...",
        readyBody: "El enlace de invitación está listo. Caduca el {{expiresAt}}.",
        ...
        shareText: "Únete a mi clasificación de Flashcards.",
  ...
  friendInvite: {
    ...
    signInBody: "Esta invitación puede conectar tu clasificación con la persona que la envió. Inicia sesión primero y luego elige cómo se mostrará su nombre para ti.",
    ...
    successBody: "Ahora podéis encontraros en la clasificación.",
