...
export const jaCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      infoToggleLabel: "このリーダーボードについて",
      info: "「難しい」「良い」「簡単」と評価した復習がランキングに数えられます。「もう一度」の復習は数えられません。",
      periodsLabel: "リーダーボードの期間",
      periods: {
        last24Hours: "24時間",
        last3Days: "3日",
        last7Days: "7日",
      ...
      invite: {
        ...
        create: "招待を作成",
        creating: "作成中...",
        readyBody: "招待リンクの準備ができました。期限は {{expiresAt}} です。",
        linkLabel: "友だち招待リンク",
        copy: "コピー",
        copying: "コピー中...",
        copied: "コピーしました。",
        ...
        shareText: "Flashcards のリーダーボードに参加してください。",
  ...
  friendInvite: {
    ...
    signInTitle: "この招待を受けるにはサインインしてください",
    signInBody: "この招待により、あなたのリーダーボードとリンクを送った人をつなげられます。まずサインインしてから、その人の名前を自分にどう表示するか選んでください。",
    signInButton: "サインイン",
    formTitle: "友だち招待を承認",
    formBody: "承認する前に非公開の名前を選んでください。",
    displayNameLabel: "このリンクを送ってくれた人をどのように表示しますか？",
    accept: "招待を承認",
    accepting: "承認中...",
    successTitle: "友だちになりました",
    successBody: "リーダーボードでお互いを見つけられるようになりました。",
    alreadyFriendsTitle: "すでに友だちです",
    alreadyFriendsBody: "この友だちは {{name}} として保存されています。",
