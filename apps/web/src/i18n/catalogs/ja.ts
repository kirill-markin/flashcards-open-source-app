...
export const jaCatalog = {
  ...
  demoCard: {
    ...
    back1: "{{appName}}——今あなたが見ているこのアプリです。",
    back2: "ここではすべてがフラッシュカードです。表に質問、裏に答えがあります。カードは自分で書くこともできますし、内蔵の AI チャットにテーマを伝えるだけでカードのセットを作ってもらうこともできます。",
    back3: "復習では、まず答えを思い出そうとして、そのあとどれくらいできたかを評価します。そこから先は各カードが自動でスケジュールされます。よく覚えているものは数週間から数か月後に、いつも忘れてしまうものは今日か明日に戻ってきます。",
    back4: "正直に評価してください。それがこの方法を機能させます。答えが分からなかった場合は{{againLabel}}を選んでください。答えをのぞき見した場合も同じです。{{hardLabel}}は、答えは知っていたが思い出すのが大変だった場合だけに使います。",
    back5: "今すぐ試してみましょう。このカードを{{againLabel}}と評価すると、約1分後にもう一度出てきます。そうすればこの答えが定着します。",
  },
  mobileAppPromo: {
    title: "スマートフォンで復習",
