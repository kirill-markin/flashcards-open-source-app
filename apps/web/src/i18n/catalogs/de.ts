...
const deCatalog: TranslationCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        readyBody: "Einladungslink ist bereit. Er läuft am {{expiresAt}} ab.",
        ...
        shareText: "Komm in meine Flashcards-Bestenliste.",
  ...
  friendInvite: {
    ...
    signInTitle: "Melde dich an, um diese Einladung anzunehmen",
    signInBody: "Diese Einladung kann deine Bestenliste mit der Person verbinden, die sie gesendet hat. Melde dich zuerst an und wähle dann, wie ihr Name für dich angezeigt wird.",
    signInButton: "Anmelden",
    formTitle: "Freundes-Einladung annehmen",
    formBody: "Wähle vor dem Annehmen einen privaten Namen.",
    displayNameLabel: "Wie möchtest du die Person sehen, die dir diesen Link geschickt hat?",
    accept: "Einladung annehmen",
    accepting: "Wird angenommen...",
    successTitle: "Ihr seid jetzt Freunde",
    successBody: "Ihr könnt euch jetzt in der Bestenliste finden.",
    alreadyFriendsTitle: "Ihr seid bereits Freunde",
    alreadyFriendsBody: "Dieser Freund ist als {{name}} gespeichert.",
