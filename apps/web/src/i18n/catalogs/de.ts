...
const deCatalog: TranslationCatalog = {
  ...
  catalogImport: {
    ...
    installDescription: "Prüfe diese Paketversion und wähle aus, wie ihre Tags importiert werden sollen.",
    previewSourceCatalog: "Öffentlicher Katalog",
    previewVersionLabel: "Version",
    advancedTitle: "Erweiterte Einstellungen",
    previewRequired: "Aktualisiere vor dem Import die Paketvorschau.",
