...
const deCatalog: TranslationCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        shareTitle: "Nibomo Freundes-Einladung",
        shareText: "Öffne diese Nibomo-Einladung, melde dich an oder registriere dich, und wir sehen uns in der App.",
  ...
  friendInvite: {
    ...
    signInTitle: "Nibomo mit dieser Einladung nutzen",
    signInBody: "Nibomo ist eine Lern-App zum Merken mit Karteikarten. Diese Einladung verbindet dich mit der Person, die sie gesendet hat, damit ihr euch in Statistiken wie Bestenlisten seht. Fahre mit deiner E-Mail fort, um die App zu nutzen und euch zu verbinden.",
    ...
    successBody: "Ihr seid jetzt Freunde in Nibomo. Aktuell könnt ihr euch in der Bestenliste finden.",
  ...
  settingsHome: {
    ...
    shareApp: {
      ...
      value: "Teilen",
      shareTitle: "Mit Nibomo lernen",
      shareText: "Öffne Nibomo auf iOS, Android oder im Web.",
      shared: "Teilen-Dialog geöffnet.",
      shareUnavailable: "Teilen ist in diesem Browser nicht verfügbar.",
    },
    reviewAppStore: {
      title: "Im App Store bewerten",
      description: "Bewerte Nibomo auf der Produktseite im App Store.",
    },
    privateFeedback: {
      title: "Privates Feedback teilen",
      description: "Sende Feedback direkt an das Nibomo-Team.",
    },
    currentWorkspace: {
  ...
  settingsWorkspace: {
    ...
    import: {
      title: "Import",
      description: "Füge Begriffe und Definitionen ein oder importiere ein Nibomo-Paket.",
      value: "Text oder ZIP",
    },
    resetProgress: {
  ...
  workspaceExport: {
    ...
    cardSelectionTagLabel: "Karten mit {{tag}} ({{count}})",
    ...
    includedTagLabel: "{{tag}} einschließen ({{count}})",
  },
  workspaceImport: {
    title: "Import",
    subtitle: "Füge Karten hinzu, indem du Text einfügst oder ein Nibomo-Paket wählst.",
    workspaceUnavailable: "Arbeitsbereich ist nicht verfügbar",
    textTitle: "Text einfügen",
    textDescription: "Kopiere Begriffe und Definitionen aus Quizlet, einer Tabelle oder einem Dokument. Prüfe jede Karte vor dem Import.",
    textInputLabel: "Begriffe und Definitionen",
    textPlaceholder: "Begriff 1\tDefinition 1\nBegriff 2\tDefinition 2",
    fieldSeparatorLabel: "Zwischen Vorder- und Rückseite",
    cardSeparatorLabel: "Zwischen Karten",
    separatorTab: "Tabulator",
    separatorComma: "Komma",
    separatorNewLine: "Neue Zeile",
    separatorSemicolon: "Semikolon",
    separatorCustom: "Benutzerdefiniert",
    customFieldSeparatorLabel: "Eigenes Trennzeichen für Vorder- und Rückseite",
    customCardSeparatorLabel: "Eigenes Trennzeichen zwischen Karten",
    ...
    textDeleteInvalid: "Alle ungültigen löschen",
    textTooManyCards: "Importiere höchstens {{count}} Karten auf einmal.",
    textTooLarge: "Die eingefügten Daten sind zu groß für einen einzelnen Import. Teile sie in kleinere Importe auf und versuche es erneut.",
    textPreviewPaginationLabel: "Seiten der Kartenvorschau",
    previousPage: "Vorherige",
    nextPage: "Nächste",
    pageStatus: "Seite {{current}} von {{total}}",
    textImportButton: "{{count}} importieren",
    textImporting: "Karten werden importiert...",
    packageTitle: "Nibomo-Paket",
    packageDescription: "Importiere eine flashcards.zip-Datei, die zuvor aus Nibomo exportiert wurde.",
    ...
    packageInvalid: "Diese Datei ist keine gültige flashcards.zip-Datei. Wähle ein Paket, das aus Nibomo exportiert wurde.",
    packageTooLarge: "Das ausgewählte Paket ist zu groß. Wähle eine kleinere flashcards.zip-Datei.",
    packageImportSuccess: "{{count}} importiert.",
    packageImportSuccessWithTag: "{{count}} mit Tag {{tag}} importiert.",
    ...
    previewRemoveTagLabel: "{{tag}} entfernen ({{count}})",
  },
  catalogImport: {
    title: "Deck aus Katalog importieren",
    loading: "Deck aus dem Katalog wird geladen...",
    packageSummary: "{{title}} — {{count}}",
    author: "Von {{author}}",
    accountEmail: "Angemeldet als {{email}}",
    signInTitle: "Anmelden oder Konto erstellen",
    signInBody: "Nutze die gemeinsame Anmelde- und Registrierungsseite und kehre dann hierher zurück, um einen Arbeitsbereich auszuwählen und dieses Deck zu importieren.",
    signInAction: "Weiter zur Anmeldung",
    errorTitle: "Katalogimport nicht verfügbar",
    errorBody: "Das Deck aus dem Katalog konnte nicht geladen werden. Versuche es erneut.",
    unavailableTitle: "Deck-Version nicht verfügbar",
    invalidVersion: "Diese Katalogimport-URL ist ungültig. Prüfe den vollständigen Link und versuche es erneut.",
    versionUnavailable: "Diese Deck-Version fehlt oder ist nicht mehr öffentlich. Prüfe den Link oder fordere eine aktuelle an.",
    ...
    installTitle: "Katalog-Deck",
    installDescription: "Prüfe diese Deck-Version vor dem Import.",
    previewSourceCatalog: "Öffentlicher Katalog",
    previewVersionLabel: "Version",
    advancedTitle: "Erweiterte Einstellungen",
    previewRequired: "Die Deck-Vorschau ist noch nicht bereit. Warte, bis sie geladen ist, oder versuche es erneut.",
    confirm: "Dieses Deck importieren",
    installing: "Wird importiert...",
    back: "Zurück",
    success: "{{count}} importiert. Durch die Synchronisierung werden sie auf deinen Geräten verfügbar.",
    successWithTag: "{{count}} mit Tag {{tag}} importiert. Durch die Synchronisierung werden sie auf deinen Geräten verfügbar.",
  ...
  analyticsSettings: {
    title: "Analyse",
    subtitle: "Lege fest, was diese App misst und ob dieser Browser ein Analyse-Cookie trägt.",
    collectionToggleTitle: "Produktanalyse erlauben",
    collectionToggleDescription: "Wenn dies aus ist, erfasst und sendet diese App nichts darüber, wie du sie nutzt. Fehler- und Absturzberichte sind davon nicht betroffen.",
    toggleTitle: "Analyse-Cookies erlauben",
    toggleDescription: "Wenn das aus ist, gibt diese App diesem Browser keine Kennung und speichert darin nichts für die Analyse. Die Produktanalyse wird dadurch nicht ausgeschaltet; das macht die Einstellung darüber.",
    error: "Das hat nicht geklappt. Bitte versuche es erneut.",
  ...
  accessSettings: {
    ...
    permission: {
      ...
      errorNotAllowedDeniedCamera: "Nibomo kann deine Kamera nicht verwenden. Klicke auf die Website-Steuerelemente in deiner Browserleiste, aktiviere den Kamerazugriff und versuche es erneut.",
      errorNotAllowedDeniedMicrophone: "Nibomo kann dein Mikrofon nicht verwenden. Klicke auf die Website-Steuerelemente in deiner Browserleiste, aktiviere den Mikrofonzugriff und versuche es erneut.",
  ...
  feedback: {
    title: "Hast du eine Idee für Nibomo?",
  ...
  chatMessageContent: {
    ...
    toolLabels: {
      ...
      getGuide: "Leitfaden abrufen",
      listWorkspaces: "Arbeitsbereiche auflisten",
      nextReviewCard: "Nächste Wiederholungskarte",
      revealAnswer: "Antwort anzeigen",
      sql: "SQL",
      sqlExecute: "SQL-Schreiben",
