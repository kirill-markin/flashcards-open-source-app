...
const hiCatalog: TranslationCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        readyBody: "आमंत्रण लिंक तैयार है। यह {{expiresAt}} पर समाप्त होगा।",
        ...
        shareText: "मेरे Flashcards लीडरबोर्ड में शामिल हों।",
  ...
  friendInvite: {
    ...
    signInTitle: "यह आमंत्रण स्वीकार करने के लिए साइन इन करें",
    signInBody: "यह आमंत्रण आपके लीडरबोर्ड को उस व्यक्ति से जोड़ सकता है जिसने इसे भेजा है। पहले साइन इन करें, फिर चुनें कि उनका नाम आपको कैसे दिखे।",
    signInButton: "साइन इन करें",
    formTitle: "दोस्त आमंत्रण स्वीकार करें",
    formBody: "स्वीकार करने से पहले एक निजी नाम चुनें।",
    displayNameLabel: "जिस व्यक्ति ने आपको यह लिंक भेजा है, उसे आप कैसे देखना चाहते हैं?",
    accept: "आमंत्रण स्वीकार करें",
    accepting: "स्वीकार हो रहा है...",
    successTitle: "अब आप दोस्त हैं",
    successBody: "अब आप लीडरबोर्ड पर एक-दूसरे को ढूंढ सकते हैं।",
    alreadyFriendsTitle: "आप पहले से दोस्त हैं",
    alreadyFriendsBody: "यह दोस्त {{name}} के रूप में सहेजा गया है।",
