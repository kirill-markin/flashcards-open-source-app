...
export const zhHansCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        create: "创建邀请",
        creating: "正在创建...",
        readyBody: "邀请链接已准备好。过期时间为 {{expiresAt}}。",
        linkLabel: "好友邀请链接",
        copy: "复制",
        copying: "正在复制...",
        copied: "已复制。",
  ...
  friendInvite: {
    ...
    errorTitle: "无法检查邀请",
    errorBody: "请检查连接后重试。",
    signInTitle: "登录以接受此邀请",
    signInBody: "此邀请可以将你的排行榜与发送链接的人连接起来。请先登录，然后选择你看到的对方名称。",
    signInButton: "登录",
    formTitle: "接受好友邀请",
    formBody: "接受前请选择一个私密名称。",
    displayNameLabel: "你想如何显示发送此链接的人？",
    accept: "接受邀请",
    accepting: "正在接受...",
    successTitle: "你们现在是好友了",
    successBody: "你们现在可以在排行榜上找到彼此。",
    alreadyFriendsTitle: "你们已经是好友",
    alreadyFriendsBody: "此好友已保存为 {{name}}。",
