...
export const zhHansCatalog = {
  ...
  progressScreen: {
    ...
    leaderboard: {
      ...
      invite: {
        ...
        sharing: "正在打开...",
        shared: "分享面板已打开。",
        shareTitle: "Nibomo 好友邀请",
        shareText: "打开这个 Nibomo 邀请，登录或注册，然后我们就能在应用中看到彼此。",
  ...
  friendInvite: {
    ...
    errorTitle: "无法检查邀请",
    errorBody: "请检查连接后重试。",
    signInTitle: "通过此邀请加入 Nibomo",
    signInBody: "Nibomo 是用抽认卡学习和记忆的应用。此邀请会将你与发送邀请的人连接起来，让你们能在排行榜等统计中看到彼此。请用电子邮件继续，以使用应用并完成连接。",
    signInButton: "登录 / 注册",
    formTitle: "选择此好友的名称",
    ...
    successBody: "你们现在是 Nibomo 好友。目前可以在排行榜上找到彼此。",
  ...
  settingsHome: {
    ...
    shareApp: {
      ...
      value: "分享",
      shareTitle: "使用 Nibomo 学习",
      shareText: "在 iOS、Android 或网页版打开 Nibomo。",
      shared: "分享面板已打开。",
      shareUnavailable: "此浏览器不支持分享。",
    },
    reviewAppStore: {
      title: "在 App Store 中评价",
      description: "在 App Store 产品页为 Nibomo 评分。",
    },
    privateFeedback: {
      title: "分享私密反馈",
      description: "直接向 Nibomo 团队发送反馈。",
    },
    currentWorkspace: {
      title: "工作区",
  ...
  settingsWorkspace: {
    ...
    import: {
      title: "导入",
      description: "粘贴词条和释义，或导入 Nibomo 包。",
      value: "文本或 ZIP",
    },
    resetProgress: {
      title: "重置学习进度",
  ...
  workspaceExport: {
    ...
    cardSelectionTagLabel: "带有 {{tag}} 的卡片（{{count}}）",
    includedTagsTitle: "包中包含的标签",
    includedTagsDescription: "这些标签会保留在导出的卡片上。导入标签会自动省略。",
    includedTagLabel: "包含 {{tag}}（{{count}}）",
  },
  workspaceImport: {
    title: "导入",
    subtitle: "粘贴文本或选择 Nibomo 包来添加卡片。",
    workspaceUnavailable: "工作区不可用",
    textTitle: "粘贴文本",
    textDescription: "从 Quizlet、电子表格或文档中复制词条和释义。导入前请检查每张卡片。",
    textInputLabel: "词条和释义",
    textPlaceholder: "词条 1\t释义 1\n词条 2\t释义 2",
    fieldSeparatorLabel: "正面与背面之间",
    cardSeparatorLabel: "卡片之间",
    separatorTab: "制表符",
    separatorComma: "逗号",
    separatorNewLine: "换行",
    separatorSemicolon: "分号",
    separatorCustom: "自定义",
    customFieldSeparatorLabel: "自定义正面与背面分隔符",
    customCardSeparatorLabel: "自定义卡片分隔符",
    ...
    textDeleteInvalid: "删除所有无效卡片",
    textTooManyCards: "每次最多导入 {{count}} 张卡片。",
    textTooLarge: "粘贴的数据太大，无法一次导入。请拆分成较小的批次后重试。",
    textPreviewPaginationLabel: "卡片预览页",
    previousPage: "上一页",
    nextPage: "下一页",
    pageStatus: "第 {{current}} 页，共 {{total}} 页",
    textImportButton: "导入 {{count}}",
    textImporting: "正在导入卡片...",
    packageTitle: "Nibomo 包",
    packageDescription: "导入此前从 Nibomo 导出的 flashcards.zip 文件。",
    ...
    packageInvalid: "此文件不是有效的 flashcards.zip。请选择从 Nibomo 导出的包。",
    packageTooLarge: "所选包太大。请选择较小的 flashcards.zip。",
    packageImportSuccess: "已导入 {{count}}。",
    packageImportSuccessWithTag: "已导入 {{count}}，标签为 {{tag}}。",
    ...
    previewRemoveTagLabel: "移除 {{tag}}（{{count}}）",
  },
  catalogImport: {
    title: "从目录导入牌组",
    loading: "正在加载目录牌组...",
    ...
    signInTitle: "登录或创建账户",
    signInBody: "使用合并的登录和注册页面，然后返回此处选择工作区并导入此牌组。",
    signInAction: "前往登录或注册",
    errorTitle: "目录导入不可用",
    errorBody: "无法加载目录牌组。请重试。",
    unavailableTitle: "牌组版本不可用",
    invalidVersion: "此目录导入 URL 无效。请检查完整链接后重试。",
    versionUnavailable: "此牌组版本不存在或已不再公开。请检查链接或获取最新链接。",
    workspaceTitle: "导入到工作区",
    workspaceDescription: "选择要接收这些卡片的工作区。",
    workspaceUnavailable: "所选工作区尚未准备好导入。请在加载完成后重试。",
    installTitle: "目录牌组",
    installDescription: "导入前请检查此牌组版本。",
    previewSourceCatalog: "公共目录",
    previewVersionLabel: "版本",
    advancedTitle: "高级设置",
    previewRequired: "牌组预览尚未就绪。请等待加载完成或重试。",
    confirm: "导入此牌组",
    installing: "正在导入...",
    back: "返回",
    success: "已导入 {{count}}。同步后可在你的设备上使用。",
    successWithTag: "已导入 {{count}}，标签为 {{tag}}。同步后可在你的设备上使用。",
    successTitle: "导入完成",
  ...
  analyticsSettings: {
    title: "使用分析",
    subtitle: "选择此应用统计什么，以及此浏览器是否携带分析 Cookie。",
    collectionToggleTitle: "允许产品使用分析",
    collectionToggleDescription: "关闭后，此应用不会收集也不会发送任何关于你如何使用它的信息。崩溃和错误报告不受影响。",
    toggleTitle: "允许分析 Cookie",
    toggleDescription: "关闭后，本应用不会给此浏览器任何标识符，也不会为统计在其中保存任何内容。这不会关闭产品分析；关闭产品分析的是上面的设置。",
    error: "没有成功，请再试一次。",
  ...
  accessSettings: {
    ...
    permission: {
      ...
      errorNotAllowedDeniedCamera: "Nibomo 无法使用您的摄像头。请点击浏览器地址栏中的站点控件，启用摄像头权限后再试。",
      errorNotAllowedDeniedMicrophone: "Nibomo 无法使用您的麦克风。请点击浏览器地址栏中的站点控件，启用麦克风权限后再试。",
  ...
  reviewScreen: {
    ...
    media: {
      ...
      imageAlt: "托管图片",
      imageFailed: "无法准备图片。",
      imageFailedAccessible: "{{label}}。无法准备图片。",
      imagePending: "图片正在准备中，很快就会显示。",
      imagePendingAccessible: "{{label}}。图片正在准备中，很快就会显示。",
      loading: "正在加载媒体...",
      unavailable: "媒体不可用",
      videoLabel: "视频附件",
    },
  ...
  demoCard: {
    ...
    back2: "给内置的 AI 聊天一个主题，它就会为您创建一套卡片。",
    back3: "现在就试试：把这张卡片评为{{againLabel}}，它大约一分钟后就会再次出现，这样这个答案就能记住了。",
  },
  mobileAppPromo: {
    title: "在手机上复习",
