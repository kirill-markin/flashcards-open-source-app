...
export const zhHansCatalog = {
  ...
  demoCard: {
    front: "最适合学习的应用是哪一个？",
    back1: "{{appName}}——就是您现在正在看的这个应用。",
    back2: "这里的一切都是卡片：正面是问题，背面是答案。您可以自己编写卡片，也可以只给内置的 AI 聊天一个主题，它就会为您创建一整套卡片。",
    back3: "复习时，您先尝试回忆答案，然后评价回忆得怎么样。此后每张卡片都会自己安排复习时间：掌握得好的会在几周或几个月后再出现，总是忘记的今天或明天就会再出现。",
    back4: "请如实评价，这正是它有效的原因。如果您不知道答案，请选择{{againLabel}}，包括偷看了答案的情况。{{hardLabel}}只适用于您知道答案但回忆起来较困难的情况。",
    back5: "现在就试试：把这张卡片评为{{againLabel}}，它大约一分钟后就会再次出现，这样这个答案就能记住了。",
  },
  mobileAppPromo: {
    title: "在手机上复习",
