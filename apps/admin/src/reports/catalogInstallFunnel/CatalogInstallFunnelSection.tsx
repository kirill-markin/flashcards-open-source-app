...
export function CatalogInstallFunnelSection(props: FunnelSectionProps): JSX.Element {
  ...
  const {
    ...
    () => buildCatalogInstallFunnelReportModel(report, groupByDimension?.id ?? null),
    [report, groupByDimension],
  );
