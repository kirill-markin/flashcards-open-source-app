...
export function AudienceSection(props: Readonly<{
  ...
  return <section className="dashboard-section" data-testid="audience-section">
    <header className="dashboard-section-header">
      ...
      <p className="dashboard-section-description">Distinct resolved users, including linked guests: everyone with at least one app open inside the selected range. Admins, example.com test accounts and the actors on the analytics exclusion list are excluded, the same rule every section applies.</p>
    </header>
