...
let settingsBannerDismissDelayNanoseconds: UInt64 = 3_000_000_000

struct SettingsOverlayBanner: Identifiable, Hashable {
    let id: String
    let message: String
}

struct SettingsOverlayBannerView: View {
    let banner: SettingsOverlayBanner
    let onDismiss: () -> Void
