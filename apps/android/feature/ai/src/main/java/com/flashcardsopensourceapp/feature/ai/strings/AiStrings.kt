...
data class AiTextProvider(
    ...
    val optimisticAssistantStatusText: String,
...
fun aiTextProvider(context: Context): AiTextProvider {
    return AiTextProvider(
        ...
        optimisticAssistantStatusText = context.getString(R.string.ai_optimistic_assistant_status),
...
fun testAiTextProvider(): AiTextProvider {
    return AiTextProvider(
        ...
        optimisticAssistantStatusText = "Looking through your cards...",
