...
class AiSupportTest {
    ...
    fun consentDisclosureQuotesPersonalWorkspaceName() {
        assertEquals(
            "AI requests from the \"Personal\" workspace can send prompts, uploaded files, images, and dictated audio to external providers.",
    ...
    fun consentDisclosureKeepsQuotedCustomWorkspaceName() {
        assertEquals(
            "AI requests from the \"fromPersonal\" workspace can send prompts, uploaded files, images, and dictated audio to external providers.",
