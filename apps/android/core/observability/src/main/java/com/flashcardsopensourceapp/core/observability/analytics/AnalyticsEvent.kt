 ...
 *
 * Twenty-five events are server-derived — `guest_upgrade_completed`, `review_answered`,
 ...
 * `ai_run_failed` and `catalog_deck_installed`. A client batch that contains any of them is
 * rejected, so they are absent here on purpose.
 *
