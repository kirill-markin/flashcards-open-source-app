...
- date, user, new/returning cohort, and platform filters open as popups from the one shared filter row, each naming in the popup what it filters and how it is counted, and the date popup opens a two-month UTC calendar whose second click applies the range
