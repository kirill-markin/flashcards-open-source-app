...
- the date range, the client platform (narrowed to iOS and Android, read off the first app open), the connection country and the app interface language all apply in SQL, the last two as on General; `@example.com`, active-admin and analytics-exclusion-list actors are excluded
...
- the date range, the client platform (read off the entry page view, always web), the connection country and the app interface language all apply in SQL, the last two as on General; `@example.com`, active-admin and analytics-exclusion-list actors are excluded
