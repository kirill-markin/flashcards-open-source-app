...
Study with an open-source, offline-first flashcards app with fast review, local-first editing, optional cloud sync, and optional AI chat.
...
The app also includes an optional custom server setting in Account Settings > Advanced > Server. This is for self-hosted deployments and is not required for normal review of the app.
